...
ACTION_HOTKEY_MAP = [
    ...
    ActionHotkeyLink(Action.CURSOR_MOVE_POSITION_RIGHT, ["KEY_RIGHT"], [Mode.EDIT], [ElementType.TEXT, ElementType.ANNOTATION]),
    ActionHotkeyLink(Action.CURSOR_MOVE_POSITION_LEFT, ["KEY_LEFT"], [Mode.EDIT], [ElementType.TEXT, ElementType.ANNOTATION]),
    ...
    ActionHotkeyLink(Action.CURSOR_MOVE_UP_STRING, ["KEY_UP"], [Mode.EDIT], [ElementType.CHORD, ElementType.ANNOTATION]),
    ActionHotkeyLink(Action.CURSOR_MOVE_DOWN_STRING, ["KEY_DOWN"], [Mode.EDIT], [ElementType.CHORD, ElementType.ANNOTATION]),
    ...
    ActionHotkeyLink(Action.MOVE_VIEW_DOWN, ["KEY_DOWN"], [Mode.HELP]),
    ActionHotkeyLink(Action.MOVE_VIEW_UP, ["KEY_UP"], [Mode.HELP]),
